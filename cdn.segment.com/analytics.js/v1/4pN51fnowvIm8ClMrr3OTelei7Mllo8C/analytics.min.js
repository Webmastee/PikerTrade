! function() {
                            ...
                            return (0, r.mG)(this, void 0, Promise, (function() {
                                ...
                                return (0, r.Jh)(this, (function(c) {
                                    switch (c.label) {
                                        ...
                                        case 1:
                                            return c.sent(), i || null === u || (u.integrations = (0, r.pi)((0, r.pi)({}, e.integrations), ((a = {})[t] = !1, a))), [2, u]
                                    }
                                }))
                            }))
                        }
    ...
    ! function() {
        ...
        var O, k, A = s(4443),
            ...
            J = null !== (O = (k = T()).__SEGMENT_INSPECTOR__) && void 0 !== O ? O : k.__SEGMENT_INSPECTOR__ = {},
            C = function(e) {
                function n(t) {
                        ...
                        return (0, t.Jh)(this, (function(t) {
                            switch (t.label) {
                                ...
                                case 7:
                                    return p++, [3, 5];
                                case 8:
                                    return null === (r = J.enriched) || void 0 === r || r.call(J, e), y = this.availableExtensions(null !== (i = e.event.integrations) && void 0 !== i ? i : {}), m = y.destinations, g = y.after, [4, new Promise((function(t, n) {
                                        setTimeout((function() {
                                ...
                                case 9:
                                    return t.sent(), e.stats.increment("message_delivered"), null === (o = J.delivered) || void 0 === o || o.call(J, e, ["segment.io"]), b = g.map((function(t) {
                                        return (0, F.a)(e, t)
                                    })), [4, Promise.all(b)];
                                case 10:
                                    return t.sent(), [2, e]
                ...
                return (0, t.ZT)(n, e), n.prototype.track = function() {
                    ...
                    return (0, t.mG)(this, void 0, Promise, (function() {
                        ...
                        return (0, t.Jh)(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    return i = new w._(e), null === (r = J.triggered) || void 0 === r || r.call(J, i), (0, b.s)() && !this.options.retryQueue ? [2, i] : (o = Date.now(), this.queue.isEmpty() ? [4, this.queue.dispatchSingle(i)] : [3, 2]);
                                case 1:
                                    return s = t.sent(), [3, 4];
                                case 2:
                ...
                return (0, t.Jh)(this, (function(P) {
                    switch (P.label) {
                        ...
                        case 2:
                            p = void 0, P.label = 3;
                        case 3:
                            return f = p, I = e, "test" !== r().NODE_ENV && Object.keys(I.integrations).length > 1 ? [4, s.e(464).then(s.bind(s, 3252)).then((function(t) {
            ...
            return void 0 === r && (r = {}), (0, t.mG)(this, void 0, Promise, (function() {
                ...
                return (0, t.Jh)(this, (function(I) {
                    switch (I.label) {
                        ...
                        case 1:
                            return [4, (j = n.writeKey, S = n.cdnURL, O = null != S ? S : (0, e.Vl)(), (0, i.Z)("".concat(O, "/v1/projects/").concat(j, "/settings")).then((function(t) {
                        ...
                        case 3:
                            return v = null === (a = null === (u = (d = h).integrations["Segment.io"]) || void 0 === u ? void 0 : u.retryQueue) || void 0 === a || a, y = (0, t.pi)({
                                    retryQueue: v
                                }, r), m = new H(n, y), null === (c = J.attach) || void 0 === c || c.call(J, m), g = null !== (l = n.plugins) && void 0 !== l ? l : [], w._.initMetrics(d.metrics),
                                function(t, e) {
                                    e.push.apply(e, kt()), Pt(t, e), xt(t, e)
                                }(m, o), [4, Mt(d, m, y, r, g)];
                        case 4:
                            return b = I.sent(), _ = null !== (f = window.location.search) && void 0 !== f ? f : "", x = null !== (p = window.location.hash) && void 0 !== p ? p : "", (P = _.length ? _ : x.replace(/(?=#).*(?=\?)/, "")).includes("ajs_") ? [4, m.queryString(P).catch(console.error)] : [3, 6];
                        case 5:
                            I.sent(), I.label = 6;
                        case 6:
                ...
                return (0, t.Jh)(this, (function(r) {
                    switch (r.label) {
                        ...
                        case 1:
                            return [2, r.sent()];
                        case 2:
                            return n = r.sent(), i = n, console.error("[analytics.js]", "Failed to load Analytics.js", i), (new Ct.B).increment("analytics_js.invoke.error", (0, t.ev)((0, t.ev)(["type:initialization"], i instanceof Error ? ["message:".concat(null == i ? void 0 : i.message), "name:".concat(null == i ? void 0 : i.name)] : [], !0), ["wk:".concat((0, Tt.M)())], !1)), [3, 3];
                        case 3:
                            return [2]
                    }
                    var i
