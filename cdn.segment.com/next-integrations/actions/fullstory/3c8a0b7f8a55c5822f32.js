(() => {
    var e, t, r = {
            ...
            5304: e => {
                var t = "\\u2700-\\u27bf",
                    ...
                    $ = g + v + ("(?:\\u200d(?:" + ["[^\\ud800-\\udfff]", d, l].join("|") + ")" + g + v + ")*"),
                    w = "(?:" + [i, d, l].join("|") + ")" + $,
                    b = RegExp([f + "?" + c + "+" + m + "(?=" + [s, f, "$"].join("|") + ")", p + "+" + y + "(?=" + [s, f + h, "$"].join("|") + ")", f + "?" + h + "+" + m, f + "+" + y, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", a, w].join("|"), "g");
                e.exports = function(e) {
                    return e.match(b) || []
                }
            },
                ...
                ! function(e) {
                    ...
                    function i(e) {
                        var n = "[A-Za-z]",
                            ...
                            S = r(r(r(m + "\\:") + "{0,5}" + m) + "?\\:\\:" + m),
                            P = r(r(r(m + "\\:") + "{0,6}" + m) + "?\\:\\:"),
                            x = r([v, g, $, w, b, _, E, S, P].join("|")),
                            j = r(r(d + "|" + a) + "+"),
                            O = (r(x + "\\%25" + j), r(x + r("\\%25|\\%(?!" + s + "{2})") + j)),
                            k = r("[vV]" + s + "+\\." + t(d, i, "[\\:]") + "+"),
                            N = r("\\[" + r(O + "|" + x + "|" + k) + "\\]"),
                            C = r(r(a + "|" + t(d, i)) + "*"),
                            T = r(N + "|" + p + "(?!" + C + ")|" + C),
                            ...
                            V = r(M + F),
                            q = "(?!" + D + ")",
                            K = (r(F + "|" + L + "|" + U + "|" + V + "|" + q), r(r(D + "|" + t("[\\/\\?]", u)) + "*")),
                            H = r(r(D + "|[\\/\\?]") + "*"),
                            B = r(r("\\/\\/" + I + F) + "|" + L + "|" + V + "|" + q),
                            G = r(l + "\\:" + B + r("\\?" + K) + "?" + r("\\#" + H) + "?"),
                            J = r(r("\\/\\/" + I + F) + "|" + L + "|" + U + "|" + q),
                            W = r(J + r("\\?" + K) + "?" + r("\\#" + H) + "?");
                        return r(G + "|" + W), r(l + "\\:" + B + r("\\?" + K) + "?"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + T + ")" + r("\\:(" + A + ")") + "?)") + "?(" + F + "|" + L + "|" + V + "|" + q + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + T + ")" + r("\\:(" + A + ")") + "?)") + "?(" + F + "|" + L + "|" + U + "|" + q + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r(r("\\/\\/(" + r("(" + f + ")@") + "?(" + T + ")" + r("\\:(" + A + ")") + "?)") + "?(" + F + "|" + L + "|" + V + "|" + q + ")"), r("\\?(" + K + ")"), r("\\#(" + H + ")"), r("(" + f + ")@"), r("\\:(" + A + ")"), {
                            ...
                            IPV6ADDRESS: new RegExp("^\\[?(" + x + ")" + r(r("\\%25|\\%(?!" + s + "{2})") + "(" + j + ")") + "?\\]?$")
                        }
                    }
                    var c = i(!1),
                        u = i(!0),
                    ...
                    var T = function(e) {
                        ...
                        I = function(e, t, r) {
                            var n = 0;
                            for (e = r ? x(e / v) : e >> 1, e += x(e / t); e > P * m >> 1; n += h) e = x(e / P);
                            return x(n + (P + 1) * e / (e + y))
                        },
                        D = function(e) {
                            var t = [],
                                r = e.length,
                                ...
                                a = e.lastIndexOf(w);
                            a < 0 && (a = 0);
                            for (var i = 0; i < a; ++i) e.charCodeAt(i) >= 128 && O("not-basic"), t.push(e.charCodeAt(i));
                            for (var c = a > 0 ? a + 1 : 0; c < r;) {
                                for (var u = n, d = 1, l = h;; l += h) {
                                    c >= r && O("invalid-input");
                                    var y = T(e.charCodeAt(c++));
                                    (y >= h || y > x((f - n) / d)) && O("overflow"), n += y * d;
                                    var v = l <= s ? p : l >= s + m ? m : l - s;
                                    if (y < v) break;
                                    var b = h - v;
                                    d > x(f / b) && O("overflow"), d *= b
                                }
                                var _ = t.length + 1;
                                s = I(n - u, _, 0 == u), x(n / _) > f - o && O("overflow"), o += x(n / _), n %= _, t.splice(n++, 0, o)
                            }
                        ...
                        R = function(e) {
                            ...
                            for (y && t.push(w); v < r;) {
                                ...
                                var T = v + 1;
                                b - n > x((f - o) / T) && O("overflow"), o += (b - n) * T, n = b;
                                var D = !0,
                                    R = !1,
                                    M = void 0;
                                try {
                                    for (var z, F = e[Symbol.iterator](); !(D = (z = F.next()).done); D = !0) {
                                        var L = z.value;
                                        if (L < n && ++o > f && O("overflow"), L == n) {
                                            for (var U = o, V = h;; V += h) {
                                                var q = V <= s ? p : V >= s + m ? m : V - s;
                                                if (U < q) break;
                                                var K = U - q,
                                                    H = h - q;
                                                t.push(j(A(q + K % H, 0))), U = x(K / H)
                                            }
                                            t.push(j(A(U, 0))), s = I(o, T, v == y), o = 0, ++v
                                        }
                                    }
                                } catch (e) {
                                    R = !0, M = e
                    ...
                    function ie(e, t) {
                        return e && e.toString().replace(t && t.iri ? u.ESCAPE : c.ESCAPE, U)
                    }
                            ...
                            serialize: function(e, t) {
                                ...
                                if (n) {
                                    for (var a = 0, i = n.length; a < i; ++a) {
                                        var c = String(n[a]),
                                            u = c.lastIndexOf("@"),
                                            d = c.slice(0, u).replace(_e, xe).replace(_e, o).replace(Ee, U),
                                            l = c.slice(u + 1);
                                        try {
                                            l = t.iri ? F.toUnicode(l) : F.toASCII(ce(l, t).toLowerCase())
                                        } catch (e) {
                                ...
                                var h = [];
                                for (var p in f) f[p] !== pe[p] && h.push(p.replace(_e, xe).replace(_e, o).replace(Se, U) + "=" + f[p].replace(_e, xe).replace(_e, o).replace(Pe, U));
            ...
            9476: (e, t, r) => {
                ...
                function n(e, t) {
                    ...
                    return (Array.isArray(t) ? t : t.match(/([^[.\]])+/g)).reduce(((e, t) => e && e[t]), e)
                }
                r.d(t, {
                    v: () => N
                });
                ...
                function i(e, t = {}, r) {
                    ...
                    function s(e, o) {
                        return s => {
                            s = s.slice(e, -e).trim();
                            const i = n(t, s),
                                c = r && r.actionsEscapeOff;
                            return o && !c ? String(function(e) {
                                return "string" != typeof e ? e : e.replace(/[&<>"'`=/]/g, (e => a[e]))
                            }(i) ? ? "") : i ? ? ""
                        }
                    }
                    return e.replace(/\{\{\{([^}]+)\}\}\}/g, s(3, !1)).replace(/\{\{([^}]+)\}\}/g, s(2, !0))
                }
                ...
                function c(e) {
                    ...
                    if ((0, o.Kn)(e)) {
                        ...
                        return Object.keys(t).forEach((e => {
                            void 0 === t[e] ? delete t[e] : t[e] = c(t[e])
                        })), t
                    }
                    return e
                }
                ...
                function h(e) {
                    const t = [];
                    return e.forEach((e => {
                        e instanceof d() ? t.push(...e) : t.push(e)
                    })), t
                }
                ...
                function y(e, t = []) {
                    if (!s(e) && !(0, o.Kn)(e)) {
                        const r = (0, o.X6)(e);
                        throw new f(`should be a directive object but it is ${_(r)} ${r}`, t)
                    }
                    const r = Object.keys(e),
                        n = r.filter((e => e.startsWith("@")));
                    if (n.length > 1) throw new f(`should only have one @-prefixed key but it has ${n.length} keys`, t);
                    if (r.filter((e => !e.startsWith("@") && "_metadata" !== e)).length > 0) throw new f(`should only have one @-prefixed key but it has ${r.length} keys`, t);
                    const a = n[0],
                        i = m[a];
                    if ("function" != typeof i) throw new f(`has an invalid directive: ${a}`, t);
                    i(e[a], t)
                }
                ...
                function v(e, t = []) {
                    ...
                    switch (r) {
                        ...
                        case "null":
                            return;
                        default:
                            throw new f(`should be a mapping directive or a JSON value but it is ${_(r)} ${r}`, t)
                    }
                }
                ...
                function g(e, t = []) {
                    ...
                    switch (r) {
                        ...
                        case "string":
                            return;
                        default:
                            throw new f(`should be a string or a mapping directive but it is ${_(r)} ${r}`, t)
                    }
                }

                function $(e, t = []) {
                    const r = p(e);
                    if ("object" !== r) throw new f(`should be an object but it is ${_(r)} ${r}`, t);
                    const n = e,
                        o = Object.keys(n),
                        s = o.find((e => "@" === e.charAt(0)));
                    if (s) throw new f(`shouldn't have directive (@-prefixed) keys but it has ${JSON.stringify(s)}`, t);
                    const a = [];
                    if (o.forEach((e => {
                            try {
                                E(n[e], [...t, e])
                        ...
                        })), a.length) throw new(d())(h(a))
                }

                function w(e, t = []) {
                    const r = (0, o.X6)(e);
                    if ("array" !== r) throw new f(`should be an array but it is ${_(r)} ${r}`, t)
                }
                    ...
                    Array.isArray(e) || (e = [e]), e.forEach((e => {
                        m[e] = (r, n = []) => {
                            try {
                                ...
                                if (e instanceof f || e instanceof d()) throw e;
                                throw new f(e.message, n)
                            }
                        }
                    }))
                }
                ...
                b("@if", ((e, t) => {
                    ! function(e, t, r = []) {
                        ...
                        if (Object.entries(t).forEach((([e, {
                                ...
                                try {
                                    if (t) {
                                        if (void 0 === o[e]) throw new f(`should have field ${JSON.stringify(e)} but it doesn't`, r);
                                        t(o[e], [...r, e])
                                    } else s && void 0 !== o[e] && s(o[e], [...r, e])
                                } catch (e) {
                                    n.push(e)
                                }
                            })), n.length) throw new(d())(h(n))
                    }(e, {
                        exists: {
                            optional: v
                        },
                ...
                function j(e, t) {
                    if (!x.exec(e)) throw new Error(`"${e}" is an invalid directive name`);
                    P[e] = t
                }
                ...
                function k(e, t, r) {
                    ...
                    if (s(e)) return function(e, t, r) {
                        const n = Object.keys(e).find((e => e.startsWith("@"))),
                            s = P[n],
                            a = e[n];
                        if ("function" != typeof s) throw new Error(`${n} is not a valid directive, got ${(0,o.X6)(s)}`);
                        return s(a, t, r)
                    }(e, t, r);
                    if (Array.isArray(e)) return e.map((e => k(e, t, r)));
                    const n = {};
                    for (const o of Object.keys(e)) n[o] = k(e[o], t, r);
                    return n
                }

                function N(e, t = {}, r) {
                    const n = (0, o.X6)(t);
                    if ("object" !== n) throw new Error(`data must be an object, got ${n}`);
                    E(e);
                    return c(k(e, t, r))
                }
                j("@if", ((e, t) => {
                    ...
                    if (void 0 !== e.exists) {
                        const n = k(e.exists, t);
                        r = null != n
                    } else if (void 0 !== e.blank) {
                        const n = k(e.blank, t);
                        r = null != n && "" != n
                    }
                    return r && void 0 !== e.then ? k(e.then, t) : !r && e.else ? k(e.else, t) : void 0
                })), j("@arrayPath", ((e, t) => {
                    if (!Array.isArray(e)) throw new Error(`@arrayPath expected array, got ${(0,o.X6)(e)}`);
                    const [r, s] = e, a = "string" == typeof r ? n(t, r.replace("$.", "")) : k(r, t);
                    return ["object", "array"].includes((0, o.X6)(a)) && "object" === (0, o.X6)(s) && Object.keys(s).length > 0 ? S(a).map((e => k(s, e))) : a
                })), O("@path", ((e, t) => n(t, e.replace("$.", "")))), O("@template", ((e, t, r) => i(e, t, r))), j("@literal", ((e, t) => k(e, t)))
            },
            6933: (e, t, r) => {
                "use strict";
            ...
            9143: (e, t, r) => {
                ...
                class u extends i {
                    ...
                    optimizeNames(e, t) {
                        if (!(this.lhs instanceof n.Name) || e[this.lhs.str] || this.sideEffects) return this.rhs = C(this.rhs, e, t), this
                    }
                    get names() {
                ...
                class m extends i {
                    ...
                    optimizeNames(e, t) {
                        ...
                        for (; n--;) {
                            const o = r[n];
                            o.optimizeNames(e, t) || (T(e, o.names), r.splice(n, 1))
                        }
                ...
                t.CodeGen = class {
                    ...
                    try (e, t, r) {
                        ...
                        return r && (this._currNode = n.finally = new O, this.code(r)), this._endBlockNode(j, O)
                    }
                    throw (e) {
                ...
                function E(e, t, r, n) {
                    ...
                    function y(h) {
                        ...
                        (function(e, t) {
                            ...
                            t.forEach((t => {
                                x(e.dataTypes, t) || j(e, `type "${t}" not allowed by context "${e.dataTypes.join(",")}"`)
                            })), e.dataTypes = e.dataTypes.filter((e => x(t, e)))
            ...
            3993: (e, t, r) => {
                ...
                class $ {
                    ...
                    addKeyword(e, t) {
                        ...
                        if (O.call(this, r, t), !t) return (0, f.eachItem)(r, (e => k.call(this, e))), this;
                        C.call(this, t);
                        const n = { ...t,
    ...
    o.m = r, o.n = e => {
    ...
    }(), o.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), e = {}, t = "[name]Destination:", o.l = (r, n, s, a) => {
        if (e[r]) e[r].push(n);
        else {
            var i, c;
            if (void 0 !== s)
        ...
        var t = (t, r) => {
                ...
                for (t && t(r); u < a.length; u++) s = a[u], o.o(e, s) && e[s] && e[s][0](), e[a[u]] = 0
            },
            r = self.webpackChunk_name_Destination = self.webpackChunk_name_Destination || [];
    ...
    (() => {
        ...
        var t, r, n = function() {
            ...
            a = function() {
                if (!!!n()) throw Error("FullStory is not loaded, please ensure the init function is invoked before calling FullStory API functions")
            },
            i = function() {
                a();
            ...
            c = function(e) {
                return function() {
                    ...
                    var r;
                    return i(e) ? (r = n())[e].apply(r, arguments) : (console.warn("FS.".concat(e, " not ready")), null)
                }
            },
            u = c("event"),
            d = c("log"),
            l = c("getCurrentSessionURL"),
            f = c("identify"),
            h = c("setUserVars"),
            p = c("consent"),
            m = c("shutdown"),
            ...
            v = c("anonymize"),
            g = (t = function(e) {
                if (n()) console.warn("The FullStory snippet has already been defined elsewhere (likely in the <head> element)");
                        ...
                        var t, r, n, o, s, a, i, c, u = e.orgId,
                            d = e.namespace,
                            l = void 0 === d ? "FS" : d,
                            f = e.debug,
                            h = void 0 !== f && f,
                            p = e.host,
                            m = void 0 === p ? "fullstory.com" : p,
                            y = e.script,
                            v = void 0 === y ? "edge.fullstory.com/s/fs.js" : y;
                        if (!u) throw new Error("FullStory orgId is a required parameter");
                        window._fs_debug = h, window._fs_host = m, window._fs_script = v, window._fs_org = u, window._fs_namespace = l, t = window, r = document, n = window._fs_namespace, o = "script", s = "user", n in t ? t.console && t.console.log && t.console.log('FullStory namespace conflict. Please set window["_fs_namespace"].') : ((i = t[n] = function(e, t, r) {
                            i.q ? i.q.push([e, t, r]) : i._api(e, t, r)
                        }).q = [], (a = r.createElement(o)).async = 1, a.crossOrigin = "anonymous", a.src = "https://" + _fs_script, (c = r.getElementsByTagName(o)[0]).parentNode.insertBefore(a, c), i.identify = function(e, t, r) {
                            i(s, {
                                uid: e
                            }, r), t && i(s, t, r)
                        }, i.setUserVars = function(e, t) {
                            i(s, e, t)
                        }, i.event = function(e, t, r) {
                            i("event", {
                                n: e,
                                p: t
                            }, r)
                            ...
                            a = "account", (t = t || {}).acctId = e, i(a, t)
                        }, i.clearUserCookie = function() {}, i.setVars = function(e, t) {
                            i("setVars", [e, t])
                        }, i._w = {}, c = "XMLHttpRequest", i._w[c] = t[c], c = "fetch", i._w[c] = t[c], t[c] && (t[c] = function() {
                            return i._w[c].apply(this, arguments)
                        }), i._v = "1.3.0")
                    }(e), !0 === e.devMode) {
                    var t = "FullStory was initialized in devMode and will stop recording";
                    u("FullStory Dev Mode", {
                        message_str: t
                    }), m(), window._fs_dev_mode = !0, console.warn(t)
                }
            }, r = "FullStory init has already been called once, additional invocations are ignored", function() {
                window._fs_initialized ? r && console.warn(r) : (t.apply(void 0, arguments), window._fs_initialized = !0)
            });
        const $ = e;
        const w = {
            title: "Track Event",
            ...
            perform: (e, t) => {
                e.event(t.payload.name, t.payload.properties ? ? {}, ee)
            }
        };
        var b = o(6009),
            _ = o.n(b);
        ...
        const S = {
                ...
                perform: (e, t) => {
                    ...
                    t.payload.traits && (r = Object.entries(t.payload.traits).reduce(((e, [t, r]) => ({ ...e,
                        [E(t)]: r
                    })), {})), t.payload.anonymousId && (r.segmentAnonymousId_str = t.payload.anonymousId), t.payload.userId ? e.identify(t.payload.userId, r, ee) : e.setUserVars({ ...r,
            ...
            P = {
                ...
                perform: (e, t) => {
                    ...
                    }, ee) : t.payload.properties && e.setVars("page", t.payload.properties, ee)
                }
            };
        o(2699);
        var x = o(3531),
        ...
        const O = e => {
                if (e.username || e.password) {
                    ...
                    return {
                        headers: {
                            Authorization: `Basic ${j()(`${t}:${r}`)}`
                        }
                    }
                }
            },
            k = async (e, t, r) => (Object.defineProperty(r.headers, "toJSON", {
                enumerable: !1,
                value: () => (e => {
                    const t = {};
            ...
            N = async (e, t, r) => {
                const n = r;
                let o;
                if (t.skipResponseCloning) o = await r.text();
                else {
                    const e = r.clone();
                    o = await e.text()
                }
                ...
                s && s.destroy();
                try {
                    a = n.headers.get("content-type") ? .includes("application/json") ? JSON.parse(o) : o
                } catch (e) {}
                return n.content = o, n.data = a, n
            };
        var C = o(7948),
            T = o.n(C),
            A = o(2501),
        ...
        function z(e, t) {
            const r = new I.Headers(e || {});
            return new I.Headers(t || {}).forEach(((e, t) => {
        ...
        function F(...e) {
            ...
            for (const n of e) {
                if (Array.isArray(n)) Array.isArray(t) || (t = []), t = [...t, ...n];
                    ...
                    for (let [e, r] of Object.entries(n)) M(r) && e in t && (r = F(t[e], r)), t[e] = r;
                    M(n.headers) && (r = z(r, n.headers))
                }
                t.headers = r
            }
            return t
        ...
        function L(...e) {
            for (const t of e)
                if (!(0, R.Kn)(t)) throw new TypeError("The 'options' argument must be an object");
            return F({}, ...e)
        }
        class U extends A.CustomError {
            constructor(e, t, r) {
                super(e.statusText ? ? String(e.status ? ? "Unknown response error")), this.response = e, this.request = t, this.options = r
            }
        }
        class V extends A.CustomError {
            constructor(e, t) {
        ...
        class q {
            ...
            setOptions(e, t) {
                ...
                if (this.options = { ...t,
                    ...
                    }, this.abortController = new(T()), this.options.signal && this.options.signal.addEventListener("abort", (() => {
                        this.abortController.abort()
                    })), this.options.signal = this.abortController.signal, this.request = new I.Request(e, this.options), this.options.searchParams) {
                    const e = new URLSearchParams(this.options.searchParams),
                        t = new URL(this.request.url);
                    t.search = e.toString(), this.request = new I.Request(new I.Request(t.toString(), this.request), this.options)
                }
                void 0 !== this.options.json && (this.options.body = JSON.stringify(this.options.json), this.request.headers.set("content-type", "application/json"), this.request = new I.Request(this.request, {
            ...
            async executeRequest() {
                ...
                for (const t of this.options.afterResponse ? ? []) {
                    ...
                    r instanceof I.Response && (e = r)
                }
                if (!e.ok && this.options.throwHttpErrors) throw new U(e, this.request, this.options);
                return e
            }
            async fetch() {
                for (const e of this.options.beforeRequest ? ? []) {
                    ...
                    t && (0, R.Kn)(t) && this.setOptions(this.request.url, L(this.options, t))
                }
                return !1 === this.options.timeout ? D(this.request.clone()) : (e = this.request.clone(), t = this.abortController, r = this.options, new Promise(((n, o) => {
                    const s = setTimeout((() => {
                        t && t.abort(), o(new V(e, r))
                    }), r.timeout);
                    D(e).then(n).catch(o).then((() => clearTimeout(s)))
                })));
                var e, t, r
            }
        }(function e(t = {}) {
            const r = (e, r = {}) => new q(e, L(t, r)).executeRequest();
            return r.extend = r => e(L(t, r)), r
        })({
            timeout: 1e4,
            headers: {
        ...
        Z.addFormat("text", !0), Z.addFormat("date-like", (e => {
            let t = W()(e);
            return String(Number(e)) === e && (13 === e.length && (t = W()(Number(e))), t = W().unix(Number(e))), t.isValid()
        }));
        for (var Y = 256, X = []; Y--;) X[Y] = (Y + 256).toString(16).substring(1);
        ...
        const ee = "segment-browser-actions",
            te = {
                ...
                initialize: async ({
                    settings: e
                }, t) => ($.init(e), await t.resolveWhen((() => Object.prototype.hasOwnProperty.call(window, "FS")), 100), window.FS)
            },
            re = (ne = te, async e => (await o.e(688).then(o.bind(o, 8688))).generatePlugins(ne, e, e.subscriptions || []));
        var ne
    })(), window.fullstoryDestination = s.default
})();
//# sourceMappingURL=3c8a0b7f8a55c5822f32.js.map